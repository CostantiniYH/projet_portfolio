...
<main class="container-fluid">
    ...
    <section class="row p-5 bg-white" id="contexte">
        ...
        <p>
            Cette activité m'a été donnée dans le cadre d'une opération de rapprochement entre les collaborateurs de notre organisation.
            En effet, avoir son propre chat, et qui plus est, créé par les membres de l'organisation facilite le contact et apporte une
            atmosphère beaucoup plus agréable dans l'établissement.
        </p>
    </section>
    ...
    <section class="row p-5 bg-dev" id="dev">
        <h4>Développement</h4>
        <hr>          
    ...
    <section class="row p-5 bg-" id="bilan">
        <h4>Bilan</h4>
    </section>
</main>