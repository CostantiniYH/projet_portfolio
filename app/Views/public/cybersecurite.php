<div class="container">
    <section class="row float-left">
        <div class="">
            ...
            <p class="alert alert-warning text-justifier">
                Cette partie est destinée au troisième bloc du BTS SIO, la cybersécurité. Cette dernière fait référence à tout ce qui est relatif à la sécurité
                informatique dans son ensemble, cela comprend la sécurité réseaux, systèmes, logiciels et développement, mais aussi les infrastructures matérielles et physiques.
                Dans cette page, vous trouverez des articles sélectionnés, des notes de cours, de la théorie et des flux RSS sur la cybersécurité. Bien sûr, le but n'est pas
                d'être exhaustif mais de présenter des informations clées sur la sécurité concernant l'option SLAM (Solution logiciels et applications métiers)
            </p>
        </div>
    </section>
    <div class="row">
        <div class="col-md">            
            ...
            ?>
            <div class="p-3 w-100 shadow mb-3 hvr-reveal rounded bg-white" data-aos="fade-up" data-aos-duration="">
                <div class="text-justify">
                    <a href="<?= $news['link'] ?>" class="text-decoration-none text-black" target="_blank">
                        ...
                        <p class="text-justifier text-black"><?= $desc ?></p>
                    </a>
        ...
        <div class="col-md">
            ...
            <?php foreach ($feed2 as $news){        
                $desc = $news['desc'];
            ?>
            <div class="p-3 w-100 shadow mb-3 hvr-overline-reveal rounded bg-white" data-aos="fade-up" data-aos-duration="">
