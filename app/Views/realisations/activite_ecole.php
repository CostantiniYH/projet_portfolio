    ...
    <section class="row g-5 p-5">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 w-100">
                ...
                <a href="<?= BASE_URL ?>ressources/masques/rapport-activite-dev_chat-slam.pdf" class="mt-auto btn btn-activite stretched-link card-footer w-100">Cliquer pour voir le détail</a>
            </div>
        </div>
